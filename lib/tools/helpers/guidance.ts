 ...
 */
export function getGuidance(context: string, runtimeProperties: runtime.RuntimeProps, source?: string) {
  switch(context){
 ...
 */
export function outputGuidance(runtimeProperties: runtime.RuntimeProps, config?: waf.WafConfig) {
